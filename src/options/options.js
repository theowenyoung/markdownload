...
const saveOptions = (e) => {
  ...
  options = {
    ...
    headingStyle: getCheckedValue(
      document.querySelectorAll("input[name='headingStyle']")
    ),
    hr: getCheckedValue(document.querySelectorAll("input[name='hr']")),
    bulletListMarker: getCheckedValue(
      document.querySelectorAll("input[name='bulletListMarker']")
    ),
    codeBlockStyle: getCheckedValue(
      document.querySelectorAll("input[name='codeBlockStyle']")
    ),
    fence: getCheckedValue(document.querySelectorAll("input[name='fence']")),
    emDelimiter: getCheckedValue(
      document.querySelectorAll("input[name='emDelimiter']")
    ),
    strongDelimiter: getCheckedValue(
      document.querySelectorAll("input[name='strongDelimiter']")
    ),
    linkStyle: getCheckedValue(
      document.querySelectorAll("input[name='linkStyle']")
    ),
    linkReferenceStyle: getCheckedValue(
      document.querySelectorAll("input[name='linkReferenceStyle']")
    ),
    imageStyle: getCheckedValue(
      document.querySelectorAll("input[name='imageStyle']")
    ),
    imageRefStyle: getCheckedValue(
      document.querySelectorAll("input[name='imageRefStyle']")
    ),
    downloadMode: getCheckedValue(
      document.querySelectorAll("input[name='downloadMode']")
    ),
...
const setCurrentChoice = (result) => {
  ...
  if (!browser.downloads) {
    ...
    document
      .querySelectorAll("[name='downloadMode']")
      .forEach((el) => (el.disabled = true));
    document.querySelector("#downloadMode p").innerText =
      "The Downloas API is unavailable in this browser.";
  }

  const downloadImages =
    options.downloadImages && options.downloadMode == "downloadsApi";

  if (
    !downloadImages &&
    (options.imageStyle == "markdown" ||
      options.imageStyle.startsWith("obsidian"))
  ) {
  ...
  document.querySelector("[name='downloadImages']").checked =
  ...
  document.querySelector("[name='turndownEscape']").checked =
    options.turndownEscape;
  document.querySelector("[name='contextMenus']").checked =
    options.contextMenus;
  document.querySelector("[name='obsidianIntegration']").checked =
    options.obsidianIntegration;
  document.querySelector("[name='obsidianVault']").value =
    options.obsidianVault;
  document.querySelector("[name='obsidianFolder']").value =
    options.obsidianFolder;

  setCheckedValue(
    document.querySelectorAll("[name='headingStyle']"),
    options.headingStyle
  );
  setCheckedValue(document.querySelectorAll("[name='hr']"), options.hr);
  setCheckedValue(
    document.querySelectorAll("[name='bulletListMarker']"),
    options.bulletListMarker
  );
  setCheckedValue(
    document.querySelectorAll("[name='codeBlockStyle']"),
    options.codeBlockStyle
  );
  setCheckedValue(document.querySelectorAll("[name='fence']"), options.fence);
  setCheckedValue(
    document.querySelectorAll("[name='emDelimiter']"),
    options.emDelimiter
  );
  setCheckedValue(
    document.querySelectorAll("[name='strongDelimiter']"),
    options.strongDelimiter
  );
  setCheckedValue(
    document.querySelectorAll("[name='linkStyle']"),
    options.linkStyle
  );
  setCheckedValue(
    document.querySelectorAll("[name='linkReferenceStyle']"),
    options.linkReferenceStyle
  );
  setCheckedValue(
    document.querySelectorAll("[name='imageStyle']"),
    options.imageStyle
  );
  setCheckedValue(
    document.querySelectorAll("[name='imageRefStyle']"),
    options.imageRefStyle
  );
  setCheckedValue(
    document.querySelectorAll("[name='downloadMode']"),
...
const refereshElements = () => {
  ...
  // });
  show(
    document.getElementById("mdClipsFolder"),
    options.downloadMode == "downloadsApi"
  );

  show(
    document.getElementById("linkReferenceStyle"),
...
const loaded = () => {
  document
    .querySelectorAll(
      ".radio-container,.checkbox-container,.textbox-container,.button-container"
    )
    .forEach((container) => {
...
document
  ...
  .forEach((el) => el.addEventListener("click", saveOptions));
document
  .querySelectorAll(".input-sizer > textarea")
  .forEach((el) => el.addEventListener("input", textareaInput));
